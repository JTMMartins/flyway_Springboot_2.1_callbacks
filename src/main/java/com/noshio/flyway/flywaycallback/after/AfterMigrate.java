package com.noshio.flyway.flywaycallback.after;
...
@Slf4j
@Component("afterMigrate")
public class AfterMigrate implements CallBackStrategy {

    @Override
    public boolean execute(Event event, Context context, JdbcOperations jdbcOperations) {
        log.info("Running strategy for event AfterMigrate");
